...
# fill na values
gun.violence$Guns_Per_Capita[is.na(gun.violence$Guns_Per_Capita)] = median(gun.violence$Guns_Per_Capita[!is.na(gun.violence$Guns_Per_Capita)])
gun.violence$Homicides[is.na(gun.violence$Homicides)] = median(gun.violence$Homicides[!is.na(gun.violence$Homicides)])
gun.violence$Suicides[is.na(gun.violence$Suicides)] = median(gun.violence$Suicides[!is.na(gun.violence$Suicides)])
